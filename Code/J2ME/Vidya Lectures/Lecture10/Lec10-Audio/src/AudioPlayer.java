/* MMAPI Audio Demo that starts, pauses and stops an audio track chosen from a list */
...
public class AudioPlayer extends MIDlet
  ...
  public void startApp() {
    ...
    itemList.append("Pretty Woman", null);
    itemList.append("Hotel California", null);
...
private void playMedia(String key) throws Exception {
	...
	file = "/letitbe.wav";
    else if (key.equals("Pretty Woman"))
	file = "/prettywo.wav";
    else 
	file = "/hotelcal.wav";
